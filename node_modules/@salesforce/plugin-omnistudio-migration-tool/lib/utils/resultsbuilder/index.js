...
class ResultsBuilder {
    static async generate(results, instanceUrl) {
        let htmlBody = '';
        ...
        fs_1.default.writeFileSync(fileUrl, doc);
        await (0, open_1.default)('file://' + fileUrl);
    }
    static generateDocument(resultsAsHtml) {
        const document = `
        <html>
            <head>
    ...
    static generateResult(migrationResult, instanceUrl) {
        let errorsBody = '';
        let tableBody = '';
