...
exports.CardMigrationTool = void 0;
const VlocityCard_1 = __importDefault(require("../mappings/VlocityCard"));
...
class CardMigrationTool extends base_1.BaseMigrationTool {
    ...
    async truncate() {
        ...
        await net_1.NetUtils.update(this.connection, recordsToUpdate);
    ...
    async getAllActiveCards() {
        utils_1.DebugTimer.getInstance().lap('Query Vlocity Cards');
    ...
    async uploadCard(allCards, card, cardsUploadInfo, originalRecords, uniqueNames) {
        ...
        try {
            ...
            if (uploadResult) {
                ...
                const updateResult = await net_1.NetUtils.updateOne(this.connection, CardMigrationTool.OMNIUICARD_NAME, recordId, uploadResult.id, {
                    [VlocityCard_1.default.Active__c]: isCardActive,
                });
